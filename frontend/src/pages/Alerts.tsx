...
import { BellRing, Filter, ChevronDown, ChevronRight, CheckCircle, AlertTriangle, ShieldAlert } from 'lucide-react'
                  ...
                  <>
                    ...
                    >
                      ...
                      <td className="px-4 py-3.5" onClick={e => e.stopPropagation()}>
                        {alert.status === 'Open' && (
                          <button className="px-2.5 py-1 text-[11px] font-medium bg-cg-primary-s text-cg-primary border border-cg-primary/30 rounded-lg hover:bg-cg-primary hover:text-white transition-all whitespace-nowrap">
                            Acknowledge
                          </button>
                        )}
                      </td>
