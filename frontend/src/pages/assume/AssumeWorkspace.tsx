        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
          {[
            ...
            },
            {
              ...
              desc: 'Natural language → executable YAML config',
              grad: 'from-blue-500/20 to-emerald-500/10',
              border: 'border-blue-500/20',
              icon_bg: 'bg-blue-500/15 text-blue-300',
            ...
            },
            {
              ...
              desc: 'Execute ASSUME simulations & stream live results',
              grad: 'from-emerald-600/20 to-emerald-500/8',
            ...
            },
            {
              ...
              label: 'Knowledge Map',
              desc: 'Explore the ASSUME entity graph & search',
              grad: 'from-cyan-500/15 to-cyan-500/5',
              border: 'border-cyan-500/20',
              icon_bg: 'bg-cyan-500/15 text-cyan-400',
